...
本轮由用户提供七彩碎片 PNG（48 × 48）及 QQ 群 719471525 原始 JPEG（1284 × 2283）。界面 Logo 和二维码按原文件逐字节复制；应用图标以最近邻整数缩放至 768 × 768 后置于 1024 × 1024 不透明浅色底，保留原像素，不使用图像生成。生成脚本：`scripts/prepare-brand-assets.ps1`。

- 原始 Logo SHA-256：`e8a90616aa073656f693860140b15b42cb702030f4babf5253619cd21e0ee968`
- 原始二维码 SHA-256：`742bf70c88385144207df45bb3463af37e8fdcc312ea27758a403df3be6bdb3f`
