...
最新修订 `a0a0a7e` 的 Release arm64 IPA 已构建并校验；两种 iPad 各 8 条 UI 流程通过，10 张本轮截图已审阅。iPhone 完整 173 项回归正在执行。具体提交和历史证据见 [构建 15 验证记录](validation/BUILD15_VERIFICATION.md)。IPA 未签名，真机安装与真实游戏往返尚未验证。
